...
[Previously](2025-06-06-setting-up-a-tor-network.md) I built an Alpine-based TOR transparent gateway for a single network that forced all traffic from the network out over TOR. It worked, but it was klunky became: 
